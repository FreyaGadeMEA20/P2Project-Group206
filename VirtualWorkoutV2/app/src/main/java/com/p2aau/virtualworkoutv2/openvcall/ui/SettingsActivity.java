...
import com.p2aau.virtualworkoutv2.openvcall.ui.layout.SettingsButtonDecoration;
import com.p2aau.virtualworkoutv2.openvcall.ui.layout.VideoEncResolutionAdapter;
...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.agora_activity_settings);
    ...
    private void setupUI() {
        ...
        ArrayAdapter<CharSequence> videoFpsAdapter = ArrayAdapter.createFromResource(this,
                R.array.string_array_frame_rate, R.layout.agora_simple_spinner_item_light);
